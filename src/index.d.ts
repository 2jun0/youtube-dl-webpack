...
// This code is refered to the repo https://github.com/microlinkhq/youtube-dl-exec

declare module 'youtube-dl-webpack' {
  type YtFormat = {
    asr: number
    filesize: number
    format_id: string
  ...
  export default function (url: string, flags?: YtFlags): Promise<YtResponse>
}
